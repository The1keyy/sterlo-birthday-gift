document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const photos = ["photos/p1.jpeg", "photos/p2.jpeg", "photos/p3.jpeg", "photos/p4.jpeg", "photos/p5.png","photos/p6.jpeg","photos/p7.jpeg","photos/p8.jpeg","photos/p9.jpeg"];
        const videos = ["videos/v1.mp4", "videos/v2.mp4", "videos/v3.mp4", "videos/v4.mp4", "videos/v5.mp4", "videos/v6.mp4", "videos/v7.mp4", "videos/v8.mp4", "videos/v9.mp4", "videos/v10.mp4", "videos/v11.mp4", "videos/v12.mp4"];
        ...
        function getUniqueMemory(isVideo) {
            ...
            if (availableItems.length === 0) {
                isVideo ? usedVideos.clear() : usedPhotos.clear(); // Reset when all have been used
        ...
        function generateMemoryGrid() {
            memoryContainer.innerHTML = ""; // Fully reset grid before regenerating
            usedPhotos.clear();
            usedVideos.clear();
    
            for (let i = 0; i < 16; i++) {
                let isVideo = (i % 2 === 0); // Ensure even distribution of videos and photos
